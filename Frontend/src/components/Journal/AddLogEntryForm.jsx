...
const AddLogEntryForm = ({ onAdd, onClose, employees = [], orders = [], currentUser = null, availableRoles = [], statusToEmojiMap = {} }) => {
    ...
    // useEffect(() => {
    //     console.log('AddLogEntryForm - employees:', employees);
    //     console.log('AddLogEntryForm - orders:', orders);
    //     console.log('AddLogEntryForm - availableRoles:', availableRoles);
    ...
    const getActiveOrders = () => {
        ...
        console.log('Active orders (normalized):', filtered);
        return filtered;
    };
        ...
        <>
            <div className="journal-form-overlay" onClick={handleClose}>
                <div className="journal-form-modal" onClick={(e) => e.stopPropagation()}>
                    ...
                    <form onSubmit={handleSubmit} className="journal-form-content" noValidate>
