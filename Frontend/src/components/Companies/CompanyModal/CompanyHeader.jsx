    ...
    <div className={styles.employeeHeader}>
      ...
      <div className={styles.mainContent}>
        <div className={styles.info}>
          <h2 className={companyName === 'Название компании' ? styles.placeholder : ''}>
            {companyName}
          </h2>
          <span className={!companyEmail && !firstContactName ? styles.placeholder : ''}>
            {displaySubtext}
          </span>
        </div>
                  ...
                  <div className={styles.tagInputContainer} ref={tagInputRef}>
                    ...
                    {showTagDropdown &&
                      (filteredTags.length > 0 ||
                        (customTag.trim() &&
                          !availableTags.includes(customTag.trim()) &&
