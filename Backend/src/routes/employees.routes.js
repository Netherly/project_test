...
router.patch('/:id/logs/:logId', EmployeesController.updateLog);
router.delete('/:id/logs/:logId', EmployeesController.deleteLog);
router.patch('/:id/logs/:logId/pin', EmployeesController.pinLog);
